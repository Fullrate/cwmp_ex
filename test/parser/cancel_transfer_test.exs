defmodule CWMP.Protocol.Parser.CancelTransferTest do
...
<SOAP-ENV:Envelope
  ...
  @sample_result {:ok,%{cwmp_version: "urn:dslforum-org:cwmp-1-0", entries: [%CWMP.Protocol.Messages.CancelTransfer{
        commandkey: "cmdkey"
      }],
