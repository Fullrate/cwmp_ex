...
\t</SOAP-ENV:Body>
  ...
  test "generates DeleteObjectResponse request" do
    assert(CWMP.Protocol.Generator.delete_object_response(%CWMP.Protocol.Messages.Header{id: "API_69412286f02e475b44783c61972f0a91"},%CWMP.Protocol.Messages.DeleteObjectResponse{status: 1}) == @sample)
  end
...
\t</SOAP-ENV:Body>
  ...
  test "generates 2nd DeleteObject request" do
    assert(CWMP.Protocol.Generator.delete_object_response(%CWMP.Protocol.Messages.Header{id: "API_69412286f02e475b44783c61972f0a91"},%CWMP.Protocol.Messages.DeleteObjectResponse{status: "0"}) == @sample2)
  end
