...
\t</SOAP-ENV:Body>
  ...
  test "generates SetParameterAttributes request" do
    assert(CWMP.Protocol.Generator.set_parameter_attributes(%CWMP.Protocol.Messages.Header{id: "API_7bfc27c1f4f0a2c1d775f8aa1840439e"},%CWMP.Protocol.Messages.SetParameterAttributes{parameters: [
