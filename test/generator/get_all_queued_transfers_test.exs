defmodule CWMP.Protocol.Generator.GetAllQueuedTransfersTest do
...
\t</SOAP-ENV:Body>
  ...
  test "generates GetAllQueuedTransfers request" do
    assert(CWMP.Protocol.Generator.get_all_queued_transfers(%CWMP.Protocol.Messages.Header{id: "API_69412286f02e475b44783c61972f0a91"}) == @sample)
  end
