defmodule CWMP.Protocol.Generator.ScheduleInformResponseTest do
...
\t</SOAP-ENV:Body>
  ...
  test "generates ScheduleInformResponse" do
    assert(CWMP.Protocol.Generator.schedule_inform_response(%CWMP.Protocol.Messages.Header{id: "API_7bfc27c1f4f0a2c1d775f8aa1840439e"}) == @sample)
  end
