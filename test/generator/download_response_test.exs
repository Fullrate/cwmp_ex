...
\t</SOAP-ENV:Body>
  ...
  test "generates full Download request" do
    assert(CWMP.Protocol.Generator.download_response(%CWMP.Protocol.Messages.Header{id: "API_69412286f02e475b44783c61972f0a91"},%CWMP.Protocol.Messages.DownloadResponse{status: "0",
