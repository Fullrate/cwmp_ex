defmodule CWMP.Protocol.Generator.ScheduleDownloadResponseTest do
...
\t</SOAP-ENV:Body>
  ...
  test "generates ScheduleDownloadResponse" do
    assert(CWMP.Protocol.Generator.schedule_download_response(%CWMP.Protocol.Messages.Header{id: "API_69412286f02e475b44783c61972f0a91"}) == @sample)
  end
