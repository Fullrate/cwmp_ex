defmodule CWMP.Protocol.Generator.FactoryResetTest do
...
\t</SOAP-ENV:Body>
  ...
  test "generates FactoryReset request" do
    assert(CWMP.Protocol.Generator.factory_reset(%CWMP.Protocol.Messages.Header{id: "API_69412286f02e475b44783c61972f0a91"}) == @sample)
  end
