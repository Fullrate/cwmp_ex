...
\t</SOAP-ENV:Body>
  ...
  test "generates GetParameterValuesResponse request" do
    assert(CWMP.Protocol.Generator.get_parameter_values_response(%CWMP.Protocol.Messages.Header{id: "API_7bfc27c1f4f0a2c1d775f8aa1840439e"},%CWMP.Protocol.Messages.GetParameterValuesResponse{parameters: [
