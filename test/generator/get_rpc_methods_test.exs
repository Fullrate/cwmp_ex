defmodule CWMP.Protocol.Generator.GetRPCMethodsTest do
...
\t</SOAP-ENV:Body>
  ...
  test "generates GetRPCMethods request" do
    assert(CWMP.Protocol.Generator.get_rpc_methods(%CWMP.Protocol.Messages.Header{id: "API_69412286f02e475b44783c61972f0a91"}) == @sample)
  end
