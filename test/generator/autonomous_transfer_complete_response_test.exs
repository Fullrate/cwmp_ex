defmodule CWMP.Protocol.Generator.AutonomousTransferCompleteResponseTest do
...
\t</SOAP-ENV:Body>
  ...
  test "generates AutonomousTransferCompleteResponse request" do
    assert(CWMP.Protocol.Generator.autonomous_transfer_complete_response(%CWMP.Protocol.Messages.Header{id: "API_69412286f02e475b44783c61972f0a91"}) == @sample)
  end
