defmodule CWMP.Protocol.Generator.TransferCompleteResponseTest do
...
\t</SOAP-ENV:Body>
  ...
  test "generates TransferComplete response" do
    assert(CWMP.Protocol.Generator.transfer_complete_response(%CWMP.Protocol.Messages.Header{id: "API_69412286f02e475b44783c61972f0a91"}) == @sample)
  end
