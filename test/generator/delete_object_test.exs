...
\t</SOAP-ENV:Body>
  ...
  test "generates DeleteObject request" do
    assert(CWMP.Protocol.Generator.delete_object(%CWMP.Protocol.Messages.Header{id: "API_69412286f02e475b44783c61972f0a91"},%CWMP.Protocol.Messages.DeleteObject{object_name: "Device.Test.", parameter_key: "ParamKey"}) == @sample)
  end
...
\t</SOAP-ENV:Body>
  ...
  test "generates 2nd DeleteObject request" do
    assert(CWMP.Protocol.Generator.delete_object(%CWMP.Protocol.Messages.Header{id: "API_69412286f02e475b44783c61972f0a91"},%CWMP.Protocol.Messages.DeleteObject{object_name: "Device.Test."}) == @sample2)
  end

  test "raise on 3nd DeleteObject request" do
    assert(catch_error(CWMP.Protocol.Generator.delete_object(%CWMP.Protocol.Messages.Header{id: "API_69412286f02e475b44783c61972f0a91"},%CWMP.Protocol.Messages.DeleteObject{object_name: "Device.Test"}))==%RuntimeError{message: "invalid objectname [Device.Test] - must end in ."})
  end
