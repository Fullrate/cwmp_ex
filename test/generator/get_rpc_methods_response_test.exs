...
\t</SOAP-ENV:Body>
  ...
  test "generates GetRPCMethods response" do
    assert(CWMP.Protocol.Generator.get_rpc_methods_response(%CWMP.Protocol.Messages.Header{id: "API_69412286f02e475b44783c61972f0a91"}, %CWMP.Protocol.Messages.GetRPCMethodsResponse{methods: ["Foo","Bar"]}) == @sample)
  end
