defmodule CWMP.Protocol.Generator.RebootResponseTest do
...
\t</SOAP-ENV:Body>
  ...
  test "generates RebootResponse request" do
    assert(CWMP.Protocol.Generator.reboot_response(%CWMP.Protocol.Messages.Header{id: "API_69412286f02e475b44783c61972f0a91"}) == @sample)
  end
