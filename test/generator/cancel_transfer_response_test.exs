defmodule CWMP.Protocol.Generator.CancelTransferResponseTest do
...
\t</SOAP-ENV:Body>
  ...
  test "generates CancelTransferResponse request" do
    assert(CWMP.Protocol.Generator.cancel_transfer_response(%CWMP.Protocol.Messages.Header{id: "API_69412286f02e475b44783c61972f0a91"}) == @sample)
  end
