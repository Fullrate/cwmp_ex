...
\t</SOAP-ENV:Body>
  ...
  test "generates TransferComplete request" do
    assert(CWMP.Protocol.Generator.transfer_complete(%CWMP.Protocol.Messages.Header{id: "API_69412286f02e475b44783c61972f0a91"}, %CWMP.Protocol.Messages.TransferCompleteRequest{
