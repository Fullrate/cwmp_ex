defmodule CWMP.Protocol.Generator.SetVouchersTest do
...
\t</SOAP-ENV:Body>
  ...
  test "generates SetVouchers request" do
    assert(CWMP.Protocol.Generator.set_vouchers(
...
xDkImsC8LuKXht/g4+nksA/3icRQXWagQJU9pUQ="
            ...
            x509_data: %CWMP.Protocol.Messages.X509DataStruct{
              issuer_serial: %CWMP.Protocol.Messages.X509IssuerSerialStruct{
...
axfzzIKiXsXwkA=="]
  ...
  test "raise, SetVouchers, no options" do
    assert( catch_error( CWMP.Protocol.Generator.set_vouchers(
    %CWMP.Protocol.Messages.Header{id: "API_69412286f02e475b44783c61972f0a91"},
