...
\t</SOAP-ENV:Body>
  ...
  test "generates AddObject request" do
    assert(CWMP.Protocol.Generator.add_object(%CWMP.Protocol.Messages.Header{id: "API_69412286f02e475b44783c61972f0a91"},%CWMP.Protocol.Messages.AddObject{object_name: "Device.Test.", parameter_key: "ParamKey"}) == @sample)
  end
...
\t</SOAP-ENV:Body>
  ...
  test "generates 2nd AddObject request" do
    assert(CWMP.Protocol.Generator.add_object(%CWMP.Protocol.Messages.Header{id: "API_69412286f02e475b44783c61972f0a91"},%CWMP.Protocol.Messages.AddObject{object_name: "Device.Test."}) == @sample2)
  end

  test "raise on 3nd AddObject request" do
    assert(catch_error(CWMP.Protocol.Generator.add_object(%CWMP.Protocol.Messages.Header{id: "API_69412286f02e475b44783c61972f0a91"},%CWMP.Protocol.Messages.AddObject{object_name: "Device.Test"}))==%RuntimeError{message: "invalid object_name [Device.Test] - must end in ."})
  end
