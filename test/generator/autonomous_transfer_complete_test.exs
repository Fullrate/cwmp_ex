...
\t</SOAP-ENV:Body>
  ...
  test "generates AutonomousTransferComplete request" do
    assert(CWMP.Protocol.Generator.autonomous_transfer_complete(%CWMP.Protocol.Messages.Header{id: "API_69412286f02e475b44783c61972f0a91"}, %CWMP.Protocol.Messages.AutonomousTransferComplete{
