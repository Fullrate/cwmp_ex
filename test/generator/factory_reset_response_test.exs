defmodule CWMP.Protocol.Generator.FactoryResetResponseTest do
...
\t</SOAP-ENV:Body>
  ...
  test "generates FactoryResetResponse" do
    assert(CWMP.Protocol.Generator.factory_reset_response(%CWMP.Protocol.Messages.Header{id: "API_69412286f02e475b44783c61972f0a91"}) == @sample)
  end
