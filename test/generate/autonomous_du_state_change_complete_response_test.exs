defmodule CWMP.Protocol.Generator.AutonomousDUStateChangeCompleteResponseTest do
...
\t</SOAP-ENV:Body>
  ...
  test "generates AutonomousDUStateChangeCompleteResponse" do
    assert(CWMP.Protocol.Generator.generate!(
      %CWMP.Protocol.Messages.Header{id: "API_69412286f02e475b44783c61972f0a91"},
      %CWMP.Protocol.Messages.AutonomousDUStateChangeCompleteResponse{}) == @sample)
  end
