...
\t</SOAP-ENV:Body>
  ...
  test "generates GetParameterAttributes request" do
    assert(CWMP.Protocol.Generator.generate(%CWMP.Protocol.Messages.Header{id: "API_7bfc27c1f4f0a2c1d775f8aa1840439e"},%CWMP.Protocol.Messages.GetParameterAttributes{parameters: ["Device.Test"]}) == @sample)
  end
